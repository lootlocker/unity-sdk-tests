...
namespace Tests
{
    public class RateLimiterTests
    {
        ...
        [UnityTest]
        public IEnumerator NormalAmountOfAverageRequestsDoesNotHitRateLimit()
        {
            // Given
        ...
        [UnityTest]
        public IEnumerator UndulatingLowLevelOfRequestsDoesNotHitRateLimit()
        {
            // Given
            int secondsToRunTest = 360;
        ...
        [UnityTest]
        public IEnumerator FrequentSmallBurstsDoesNotHitRateLimit()
        {
            // Given
            int secondsToRunTest = 360;
        ...
        [UnityTest]
        public IEnumerator InfrequentLargeBurstsDoesNotHitRateLimit()
        {
            // Given
            int secondsToRunTest = 360;
        ...
        [UnityTest]
        public IEnumerator ExcessiveQuickSuccessionRequestsHitsTripwireRateLimit()
        {
            // Given
        ...
        [UnityTest]
        public IEnumerator LowLevelBackgroundRequestsWithIntermittentBurstsHitsRateLimit()
        {
            // Given
        ...
        [UnityTest]
        public IEnumerator SuddenHugeBurstBelowLimitDoesNotTriggerRateLimit()
        {
            // Given
            int maxSecondsToRunTest = 90;
        ...
        [UnityTest]
        public IEnumerator SuddenHugeBurstAboveLimitTriggersRateLimit()
        {
            // Given
            int maxSecondsToRunTest = 90;
        ...
        [UnityTest]
        public IEnumerator SuddenHugeBurstBelowLimitFollowedByAFewRequestsTriggersRateLimit()
        {
            // Given
        ...
        [UnityTest]
        public IEnumerator ConstantRequestsBelowTripWireStillHitsMovingAverageRateLimit()
        {
            // Given
            int maxSecondsToRunTest = 360;
        ...
        [UnityTest]
        public IEnumerator AfterHavingBeenSetOffTheRateLimitingCancelsAfter3Minutes()
        {
            // Given
